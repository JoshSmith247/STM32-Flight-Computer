...
# VIDEO_SOURCE: "" = UDP stream from Pi (default); "0","1" = webcam by index;
# a file path = local video file (loops automatically).
...
PROGRAMS       = ['MANUAL', 'FOLLOW ME', 'WEED PICKER', 'RETURN HOME', 'DEMO HOVER']
PROG_MANUAL    = 0
PROG_FOLLOW_ME = 1
PROG_WEED_PICK = 2
PROG_RTH       = 3
